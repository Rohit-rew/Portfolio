      ...
      <main className="projects">
        ...
        <div className="text-static-layer">
          ...
          <div className="static-text-area">
            ...
            <p>As a web developer I convert your dream into reality using the latest technologies</p>
        ...
        <h1>WEB DEVELOPMENT CUSTOM WEBSITE INTERACTIVE RESPONSIVE FULLY CUSTOMISED UNIQUE ELEGANT GRAPHICS </h1>
